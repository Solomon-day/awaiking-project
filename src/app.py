...
tab4_inflation = [
    ...
    dbc.Row([
        ...
        html.P('''На графике отображена динамика стоимости золота в долларах США.Примечательно то, что до отмены Бреттон-Вудской системы в ~1976 году цена на золото практически не изменялась.
...
app.layout = html.Div([
    dbc.Row([
        ...
        dbc.Col(html.H1('Awaking Project'),
                width={'size': 7}),
